...
INCLUDES_GPU=-I/opt/opencv/2.4.5-gpu/include/opencv -I/opt/opencv/2.4.5-gpu/include -I/usr/local/include -I.
...
opt:
	@g++ $(GCCFLAGS) -fast -Wall -ansi $(INCLUDES) -L/opt/opencv/2.4.5/lib -L/usr/local/lib -c blobUtils.cpp -o blobUtils.o
	@g++ $(GCCFLAGS) -fast -Wall -ansi $(INCLUDES) -L/opt/opencv/2.4.5/lib -L/usr/local/lib -c larvaSkel.cpp -o larvaSkel.o
	@g++ $(GCCFLAGS) -fast -Wall -ansi $(INCLUDES) -L/opt/opencv/2.4.5/lib -L/usr/local/lib -c larvaDistanceMap.cpp -o larvaDistanceMap.o
	@g++ $(GCCFLAGS) -fast -Wall -ansi $(INCLUDES) -L/opt/opencv/2.4.5/lib -L/usr/local/lib -c larvaObject.cpp -o larvaObject.o
	@g++ $(GCCFLAGS) -fast -Wall -ansi $(INCLUDES) -L/opt/opencv/2.4.5/lib -L/usr/local/lib main.cpp $(LIBS) -o lrvTrack *.o
